            ...
            function ($window, $rootScope, $compile, GenerateList,
                ...
                return {
                    ...
                    buildHTML: function (form, options) {
                        ...
                        if(options.box)
                        {
                        	console.log(form[$window.localStorage.getItem('form_id')]);
                        	console.log($window.localStorage.getItem('form_id'));
                        	this.setForm(form[$window.localStorage.getItem('form_id')]);
                        }
                        else
                        {
                        	//this.modal = (options.modal) ? true : false;
