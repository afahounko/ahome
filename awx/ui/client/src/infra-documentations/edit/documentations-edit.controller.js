...
export default ['$window', '$scope', '$rootScope', '$stateParams', 'DocumentationForm', 'GenerateForm', 'Rest','ParseTypeChange',
    'Alert', 'ProcessErrors', 'ReturnToCaller', 'GetBasePath',
    'Wait', 'CreateSelect2', '$state', '$location', 'i18n','ParseVariableString',
    function($window, $scope, $rootScope, $stateParams, DocumentationForm, GenerateForm, Rest, ParseTypeChange, Alert,
